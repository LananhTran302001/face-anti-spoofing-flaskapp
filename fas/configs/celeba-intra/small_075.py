...
datasets = dict(LCCFASD_root='./LCC_FASDcropped',
                Celeba_root='/home/dev/lananh/data/CelebA_Spoof',
                Casia_root='./CASIA')
...
checkpoint = dict(snapshot_name="MobileNet3_small_075.pth.tar",
                  experiment_path='./logs/v0/small075',
...
trainval_dataset = 'celeba_spoof'

test_dataset = 'celeba_spoof'
